...
def has_combination_test() -> bool:
    ...
    tests = [
        ...
        (101010101, 5),
        (102030405, 9),
        (1011011101111011111, 12345),
        (1011011101111011111, 11122),
        (10203040506, 1),
    ]
    test_sols = [
        True,
...
def safe_cracking_test() -> bool:
    ...
    tests = [
        ...
        ([20302, 20305], 2, 5),
        ([20305, 20302], 2, 5),
        ([305070503, 13015017071051031, 2030405040302], 6, 46),
        ([20305, 20306], 2, 5),
        ([3050709011, 13015017071051031, 1012], 3, 13),
    ]
...
def max_items_test() -> bool:
    ...
    tests = [
        ...
        ([8, 4, 10, 6, 2, 1, 1], 6),
        ((100 * [20]) + ([10] * 100), 727),
        ([1, 2, 3, 5005129], 5005135),
        ([16, 15, 6, 7, 3], 15),
        ([14, 1, 13, 2, 12, 3, 11, 4, 10, 5, 9, 6, 8, 7], 15),
    ]
